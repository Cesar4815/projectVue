...
<script>
  ...
  export default {
    ...
    data () {
      return {
        playlist: [
        {title: "bensound energy", artist: "Bensound", howl: null, display: true},
        {title: "bensound happyrock", artist: "Bensound", howl: null, display: true},
        {title: "bensound highoctane", artist: "Bensound", howl: null, display: true},
        {title: "bensound moose", artist: "Bensound", howl: null, display: true}],
        selectedTrack: null,
        index: 0,
        playing: false,
        loop: false,
